...
var Braintree = (function (_super) {
     ...
     */
    Braintree.prototype.initialize = function (token) { return; };
    /**
     ...
     * @return {Promise<undefined | string>} Returns a promise that resolves with undefined on successful initialization, or rejects with a string message describing the failure.
     */
    Braintree.prototype.setupApplePay = function (options) { return; };
    /**
     ...
     */
    Braintree.prototype.presentDropInPaymentUI = function (options) { return; };
    Braintree.decorators = [
        { type: Injectable },
    ];
    /** @nocollapse */
    Braintree.ctorParameters = function () { return []; };
    __decorate([
        Cordova({
